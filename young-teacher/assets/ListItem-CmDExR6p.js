import{G as e,N as t,b as n,d as r,v as i,x as a}from"./index-X-kpf5ZD.js";import{J as o,O as s,R as c,T as l,_t as u,bt as d,et as f,gt as p,h as m,ht as h,mt as g,st as _,xt as v,z as y}from"./useGameState-CgcZhkar.js";function b(e){let{textColor2:t,cardColor:n,modalColor:r,popoverColor:i,dividerColor:a,borderRadius:o,fontSize:s,hoverColor:c}=e;return{textColor:t,color:n,colorHover:c,colorModal:r,colorHoverModal:_(r,c),colorPopover:i,colorHoverPopover:_(i,c),borderColor:a,borderColorModal:_(r,a),borderColorPopover:_(i,a),borderRadius:o,fontSize:s}}var x={name:`List`,common:m,self:b},S=g([h(`list`,`
